...
import cutscenes.DialogueBoxStarlight;
...
import starlightlua.LuaUtils;
import starlightlua.LuaUtils.LuaTweenOptions;
#if HSCRIPT_ALLOWED
import starlightlua.HScript;
#end
import starlightlua.DebugLuaText;
import starlightlua.ModchartSprite;
...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('version', MainMenuState.starlightEngineVersion.trim());
		...
		Lua_helper.add_callback(lua, "startDialogue", function(dialogueFile:String, ?music:String = null) {
			...
			#end
			{
				var shit:DialogueFile = DialogueBoxStarlight.parseDialogue(path);
